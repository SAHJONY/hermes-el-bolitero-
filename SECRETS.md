...
| `MAGAYO_BOARDS` | Opcional | Tableros que SÍ se consultan en magayo (ahorra cuota). Por defecto `florida,georgia,chicago,pr,texas,newjersey`. New York es gratis y siempre real; el resto muestra DEMO. Pon `all` para todos | ids de tablero |
